...
def test_validation1DTransportEquationCenteredImplicit(cfl,isSmooth):
    ...
    plt.savefig(mesh_name+"_1DTransportEquationCentered"+"_PlotOfSolution.png")    
    plt.close()
    ...
    plt.savefig(mesh_name+"_1DTransportEquationCentered"+"_MaxSolution.png")
    ...
    plt.savefig(mesh_name+"_1DTransportEquationCentered"+"_TotalVariation.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation1DTransportEquationCentered() : Make sure you use distinct meshes and at least two meshes'
    ...
    plt.savefig(mesh_name+"1DTransportEquationCentered_"+"_ConvergenceCurve.png")
    ...
    plt.savefig(mesh_name+"1DTransportEquationCentered_"+"_ComputationalTime.png")
