...
def test_validation2DWaveSystemCenteredCheckerboard(bctype):
    ...
    for filename in meshList:
        error_p_tab[i], error_u_tab[i], mesh_size_tab[i], t_final[i], ndt_final[i], max_vel[i], diag_data_press[i], diag_data_vel[i], time_tab[i] =WaveSystemCentered.solve_file(mesh_path+filename, mesh_name, resolution,meshType,testColor,cfl,bctype)
    ...
    plt.savefig(mesh_name+'_Pressure_2DWaveSystemCentered_Checkerboard_'+"PlotOverDiagonalLine.png")
    plt.close()
    ...
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemCentered_Checkerboard_"+"PlotOverDiagonalLine.png")    
    plt.close()
    ...
    print "FV centered on 2D checkerboard meshes : scheme order for pressure is ", -ap
    ...
    print "FV centered on 2D checkerboard meshes : scheme order for velocity is ", -au
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCheckerboardCentered_"+"TimeSteps.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCheckerboardCentered_"+"TimeFinal.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCheckerboardCentered_"+"MaxVelNorm.png")
    ...
    plt.savefig(mesh_name+"_Pressure_2DWaveSystemCentered_Checkerboard_"+"ConvergenceCurve.png")
    ...
    plt.ylabel('error u')
    plt.title('Convergence of finite volumes for the stationary Wave System \n with centered scheme on 2D checkerboard meshes')
    plt.savefig(mesh_name+"_Velocity_2DWaveSystemCentered_Checkerboard_"+"ConvergenceCurve.png")
    ...
    plt.savefig(mesh_name+"_2DWaveSystemCentered_Checkerboard_ComputationalTime.png")
