...
#        error_tab[i], mesh_size_tab[i], diag_data[i], min_sol_num, max_sol_num, time_tab[i] =FiniteVolumes2DDiffusion_SQUARE.solve_file(mesh_path+filename,resolution,meshType,testColor)
    ...
    import os
    os.system("jupyter-nbconvert --to notebook --execute Convergence_Diffusion_FV5_SQUARE_long_triangles.ipynb")
    os.system("jupyter-nbconvert --to html Convergence_Diffusion_FV5_SQUARE_long_triangles.ipynb")
    os.system("jupyter-nbconvert --to pdf Convergence_Diffusion_FV5_SQUARE_long_triangles.ipynb")
