...
def test_validation2DVF_triangles():
    ...
    import os
    os.system("jupyter-nbconvert --to notebook --execute Convergence_Diffusion_FV5_SQUARE_triangles.ipynb")
    os.system("jupyter-nbconvert --to html Convergence_Diffusion_FV5_SQUARE_triangles.ipynb")
    os.system("jupyter-nbconvert --to pdf Convergence_Diffusion_FV5_SQUARE_triangles.ipynb")
