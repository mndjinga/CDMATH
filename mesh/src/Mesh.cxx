...
//----------------------------------------------------------------------
{
	...
	else
	{
		...
		{
		cout<<"Before  fieldn=buildOrthogonalField() spaceDim!=meshDim may lead to failure"<<endl;
			fieldn = m2->buildOrthogonalField();
		cout<<"After  fieldn=buildOrthogonalField()"<<endl;
		}
		...
		{
		cout<<"Before  orthoField=buildOrthogonalField()  spaceDim!=meshDim may lead to failure"<<endl;
			orthoField = m2->buildOrthogonalField();
		cout<<"After  orthoField=buildOrthogonalField()"<<endl;
		}
