...
def test_validation3DVF_ns():
    ...
    plt.savefig(mesh_name+"_3DPoissonVFns_PlotOverDiagonalLine.png")
    ...
    det=a1*a3-a2*a2
    assert det!=0, 'test_validation3DVF_ns() : Make sure you use distinct meshes and at least two meshes'
    a=( a3*b1-a2*b2)/det
    b=(-a2*b1+a1*b2)/det
    ...
    plt.savefig(mesh_name+"_3DPoissonVFns_ConvergenceCurve.png")
